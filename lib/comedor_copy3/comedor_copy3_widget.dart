...
class ComedorCopy3Widget extends StatefulWidget {
  const ComedorCopy3Widget({Key key}) : super(key: key);

  @override
  _ComedorCopy3WidgetState createState() => _ComedorCopy3WidgetState();
}

class _ComedorCopy3WidgetState extends State<ComedorCopy3Widget> {
