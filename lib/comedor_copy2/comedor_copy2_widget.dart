...
class ComedorCopy2Widget extends StatefulWidget {
  const ComedorCopy2Widget({Key key}) : super(key: key);

  @override
  _ComedorCopy2WidgetState createState() => _ComedorCopy2WidgetState();
}

class _ComedorCopy2WidgetState extends State<ComedorCopy2Widget> {
