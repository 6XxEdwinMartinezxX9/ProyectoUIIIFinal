...
class INFORMACIONCopyWidget extends StatefulWidget {
  const INFORMACIONCopyWidget({Key key}) : super(key: key);

  @override
  _INFORMACIONCopyWidgetState createState() => _INFORMACIONCopyWidgetState();
}

class _INFORMACIONCopyWidgetState extends State<INFORMACIONCopyWidget> {
