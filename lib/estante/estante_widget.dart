...
class EstanteWidget extends StatefulWidget {
  const EstanteWidget({Key key}) : super(key: key);

  @override
  _EstanteWidgetState createState() => _EstanteWidgetState();
}

class _EstanteWidgetState extends State<EstanteWidget> {
