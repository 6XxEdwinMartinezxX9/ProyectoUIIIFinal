...
class ComedorCopyWidget extends StatefulWidget {
  const ComedorCopyWidget({Key key}) : super(key: key);

  @override
  _ComedorCopyWidgetState createState() => _ComedorCopyWidgetState();
}

class _ComedorCopyWidgetState extends State<ComedorCopyWidget> {
